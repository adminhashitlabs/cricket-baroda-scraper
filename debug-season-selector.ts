import { CricketBarodaTournamentDiscovery } from './src/platforms/cricket-baroda-tournament-discovery';
    ...
    try {
        ...
        if (!selectorExists.exists) {
            ...
            for (const altSelector of alternativeSelectors) {
                const altResult = await discovery['scraper']['page']!.evaluate((sel) => {
